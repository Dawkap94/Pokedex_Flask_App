...
all_evolutions = [['bulbasaur', 'ivysaur', 'venusaur'], ['charmander', 'charmeleon', 'charizard'],
                ...
                ['diglett', 'dugtrio'], ['meowth', 'persian', 'perrserker'], ['psyduck', 'golduck'], ['mankey', 'primeape'],
                ...
                ['slowpoke', 'slowbro', 'slowking'], ['magnemite', 'magneton', 'magnezone'], ['farfetchd'], ['doduo', 'dodrio'],
                ...
                ['exeggcute', 'exeggutor'], ['cubone', 'marowak'], ['tyrogue', 'hitmonlee', 'hitmonchan', "hitmontop"], ['lickitung', 'lickilicky'],
                ['koffing', 'weezing'], ['rhyhorn', 'rhydon', 'rhyperior'], ['happiny', 'chansey', 'blissey'], ['tangela', 'tangrowth'], ['kangaskhan'],
                ['horsea', 'seadra', 'kingdra'], ['goldeen', 'seaking'], ['staryu', 'starmie'], ['mime-jr', 'mr-mime', 'mr-rime'], ['scyther', 'scizor', 'kleavor'],
                ['smoochum', 'jynx'], ['elekid', 'electabuzz', 'electivire'], ['magby', 'magmar', 'magmortar'], ['pinsir'], ['tauros'], ['magikarp', 'gyarados'], ['lapras'],
