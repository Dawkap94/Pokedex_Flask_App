...
all_evolutions = [['bulbasaur', 'ivysaur', 'venusaur'], ['charmander', 'charmeleon', 'charizard'],
                ['squirtle', 'wartortle', 'blastoise'], ['caterpie', 'metapod', 'butterfree'],
                ['weedle', 'kakuna', 'beedrill'], ['pidgey', 'pidgeotto', 'pidgeot'],
                ['rattata', 'raticate'], ['spearow', 'fearow'], ['ekans', 'arbok'],
                ['pichu', 'pikachu', 'raichu'], ['sandshrew', 'sandslash'], ['nidoran-f', 'nidorina', 'nidoqueen'],
                ['nidoran-m', 'nidorino', 'nidoking'], ['cleffa', 'clefairy', 'clefable'], ['vulpix', 'ninetales'],
                ['igglybuff', 'jigglypuff', 'wigglytuff'], ['zubat', 'golbat', "crobat"],
                ['oddish', 'gloom', 'vileplume', 'bellossom'], ['paras', 'parasect'], ['venonat', 'venomoth'],
                ['diglett', 'dugtrio'], ['meowth', 'persian', 'perrserker'], ['psyduck', 'golduck'],
                ['mankey', 'primeape'], ['growlithe', 'arcanine'], ['poliwag', 'poliwhirl', 'poliwrath', 'politoed'],
                ['abra', 'kadabra', 'alakazam'], ['machop', 'machoke', 'machamp'],
                ['bellsprout', 'weepinbell', 'victreebel'], ['tentacool', 'tentacruel'],
                ['geodude', 'graveler', 'golem'], ['ponyta', 'rapidash'], ['slowpoke', 'slowbro', 'slowking'],
                ['magnemite', 'magneton', 'magnezone'], ['farfetchd'], ['doduo', 'dodrio'], ['seel', 'dewgong'],
                ['grimer', 'muk'], ['shellder', 'cloyster'], ['gastly', 'haunter', 'gengar'],
                ['onix', 'steelix'], ['drowzee', 'hypno'], ['krabby', 'kingler'], ['voltorb', 'electrode'],
                ['exeggcute', 'exeggutor'], ['cubone', 'marowak'], ['tyrogue', 'hitmonlee', 'hitmonchan', "hitmontop"],
                ['lickitung', 'lickilicky'], ['koffing', 'weezing'], ['rhyhorn', 'rhydon', 'rhyperior'],
                ['happiny', 'chansey', 'blissey'], ['tangela', 'tangrowth'], ['kangaskhan'],
                ['horsea', 'seadra', 'kingdra'], ['goldeen', 'seaking'], ['staryu', 'starmie'],
                ['mime-jr', 'mr-mime', 'mr-rime'], ['scyther', 'scizor', 'kleavor'], ['smoochum', 'jynx'],
                ['elekid', 'electabuzz', 'electivire'], ['magby', 'magmar', 'magmortar'], ['pinsir'], ['tauros'], ['magikarp', 'gyarados'], ['lapras'],
                ['ditto'], ['eevee', 'vaporeon', 'jolteon', 'flareon', 'espeon', 'umbreon', "sylveon", "glaceon", "leafeon"], ['porygon'], ['omanyte', 'omastar'],
                ['kabuto', 'kabutops'], ['aerodactyl'], ['munchlax', 'snorlax'], ['articuno'], ['zapdos'], ['moltres'],
                ...
                ['chinchou', 'lanturn'], ['togepi', 'togetic', 'togekiss'], ['natu', 'xatu'],
                ['mareep', 'flaaffy', 'ampharos'], ['azurill', 'marill', 'azumarill'], ['bonsly', 'sudowoodo'],
                ['hoppip', 'skiploom'], 'jumpluff', ['aipom', 'ambipom'], ['sunkern', 'sunflora'], ['yanma', 'yanmega'],
                ['wooper', 'quagsire'], ['murkrow','honchkrow'], ['misdreavus', 'mismagius'], ['unown'], ['wynaut', 'wobbuffet'], ['girafarig'],
                ['pineco', 'forretress'], 'dunsparce', ['gligar', 'gliscor'], ['snubbull', 'granbull'], ['qwilfish'], ['shuckle'],
                ['heracross'], ['sneasel', 'weavile', 'sneasler'], ['teddiursa', 'ursaring', 'ursaluna'], ['slugma', 'magcargo'], ['swinub', 'piloswine'],
                ['corsola'], ['remoraid', 'octillery'], ['delibird'], ['mantine'], ['skarmory'], ['houndour', 'houndoom'],
                ['phanpy', 'donphan'], ['stantler', 'wyrdeer'], ['smeargle'],
                ['miltank'], ['raikou'], ['entei'], ['suicune'], ['larvitar', 'pupitar', 'tyranitar'], ['lugia'],
                ['ho-oh'], ['celebi'], ['treecko', 'grovyle', 'sceptile'], ['torchic', 'combusken', 'blaziken'],
                ['mudkip', 'marshtomp', 'swampert'], ['poochyena', 'mightyena'], ['zigzagoon', 'linoone', 'obstagoon'],
                ...
                ['nosepass'], ['skitty', 'delcatty'], ['sableye'], ['mawile'], ['aron', 'lairon', 'aggron'],
                ['meditite', 'medicham'], ['electrike', 'manectric'], ['plusle'], ['minun'], ['volbeat'], ['illumise'],
                ['budew', 'roselia', 'roserade'], ['gulpin', 'swalot'], ['carvanha', 'sharpedo'], ['wailmer', 'wailord'], ['numel', 'camerupt'],
                ...
                ['feebas', 'milotic'], ['castform'], ['kecleon'], ['shuppet', 'banette'], ['duskull', 'dusclops', 'dusknoir'],
                ['tropius'], ['chimecho'], ['absol'], ['snorunt', 'glalie', 'froslass'], ['spheal', 'sealeo', 'walrein'],
                ...
                ['kyogre'], ['groudon'], ['rayquaza'], ['jirachi'], ['deoxys-normal'], ['turtwig', 'grotle', 'torterra'],
                ...
                ['chatot'], ['spiritomb'], ['gible', 'gabite', 'garchomp'], ['riolu', 'lucario'], ['hippopotas', 'hippowdon'], ['skorupi', 'drapion'],
                ['croagunk', 'toxicroak'], ['carnivine'], ['finneon', 'lumineon'], ['mantyke'], ['snover', 'abomasnow'],
                ['mamoswine'], ['gallade'], ['probopass'], ['rotom'], ['uxie'], ['mesprit'], ['azelf'], ['dialga'], ['palkia'],
                ['heatran'], ['regigigas'], ['giratina-altered'], ['cresselia'], ['phione'], ['manaphy'], ['darkrai'],
                ['shaymin-land'], ['arceus'], ['victini'], ['snivy', 'servine', 'serperior'], ['tepig', 'pignite', 'emboar'],
                ...
                ['roggenrola', 'boldore', 'gigalith'], ['woobat', 'swoobat'], ['drilbur', 'excadrill'], ['audino'],
                ...
                ['virizion'], ['tornadus-incarnate'], ['thundurus-incarnate'], ['reshiram'], ['zekrom'], ['landorus-incarnate'],
                ['kyurem'], ['keldeo-ordinary'], ['meloetta-aria'], ['genesect'], ['chespin', 'quilladin', 'chesnaught'],
                ...
                ['flabebe', 'floette', 'florges'], ['skiddo', 'gogoat'], ['pancham', 'pangoro'], ['furfrou'],
                ['espurr', 'meowstic-male'], ['honedge', 'doublade', 'aegislash-shield'], ['spritzee', 'aromatisse'],
                ...
                ['noibat', 'noivern'], ['xerneas'], ['yveltal'], ['zygarde-50'], ['diancie'], ['hoopa'], ['volcanion'],
                ...
                ['wishiwashi-solo'], ['mareanie', 'toxapex'], ['mudbray', 'mudsdale'], ['dewpider', 'araquanid'],
                ...
                ['sandygast', 'palossand'], ['pyukumuku'], ['type-null', 'silvally'], ['minior-red-meteor'], ['komala'],
                ['turtonator'], ['togedemaru'], ['mimikyu-disguised'], ['bruxish'], ['drampa'], ['dhelmise'],
                ...
                ['cramorant'], ['arrokuda', 'barraskewda'], ['toxel', 'toxtricity-amped'], ['sizzlipede', 'centiskorch'],
                ['clobbopus', 'grapploct'], ['sinistea', 'polteageist'], ['hatenna', 'hattrem', 'hatterene'],
                ['impidimp', 'morgrem', 'grimmsnarl'], ['cursola'], ['sirfetchd'],
                ['runerigus'], ['milcery', 'alcremie'], ['falinks'], ['pincurchin'], ['snom', 'frosmoth'], ['stonjourner'],
                ['eiscue-ice'], ['indeedee-male'], ['morpeko-full-belly'], ['cufant', 'copperajah'], ['dracozolt'], ['arctozolt'],
                ['dracovish'], ['arctovish'], ['duraludon'], ['dreepy', 'drakloak', 'dragapult'], ['zacian'], ['zamazenta'],
                ['eternatus'], ['kubfu', 'urshifu-single-strike'], ['zarude'], ['regieleki'], ['regidrago'], ['glastrier'],
                ['spectrier'], ['calyrex'], ['basculegion-male'],
                ['overqwil'], ['enamorus-incarnate']]


all_pokemons = ['bulbasaur', 'ivysaur', 'venusaur', 'charmander', 'charmeleon', 'charizard', 'squirtle', 'wartortle',
                ...
                'swalot', 'carvanha', 'sharpedo', 'wailmer', 'wailord', 'numel', 'camerupt', 'torkoal', 'spoink',
                'grumpig', 'spinda', 'trapinch', 'vibrava', 'flygon', 'cacnea', 'cacturne', 'swablu', 'altaria',
                ...
                'kyogre', 'groudon', 'rayquaza', 'jirachi', 'deoxys-normal', 'turtwig', 'grotle', 'torterra', 'chimchar',
                ...
                'poipole', 'naganadel', 'stakataka', 'blacephalon', 'zeraora', 'meltan', 'melmetal', 'grookey', 'thwackey',
                'rillaboom', 'scorbunny', 'raboot', 'cinderace', 'sobble', 'drizzile', 'inteleon', 'skwovet', 'greedent',
                'rookidee', 'corvisquire', 'corviknight', 'blipbug', 'dottler', 'orbeetle', 'nickit', 'thievul',
                'gossifleur', 'eldegoss', 'wooloo', 'dubwool', 'chewtle', 'drednaw', 'yamper', 'boltund', 'rolycoly',
                'carkol', 'coalossal', 'applin', 'flapple', 'appletun', 'silicobra', 'sandaconda', 'cramorant',
                'arrokuda', 'barraskewda', 'toxel', 'toxtricity-amped', 'sizzlipede', 'centiskorch', 'clobbopus',
                'grapploct', 'sinistea', 'polteageist', 'hatenna', 'hattrem', 'hatterene', 'impidimp', 'morgrem',
                'grimmsnarl', 'obstagoon', 'perrserker', 'cursola', 'sirfetchd', 'mr-rime', 'runerigus', 'milcery',
                'alcremie', 'falinks', 'pincurchin', 'snom', 'frosmoth', 'stonjourner', 'eiscue-ice', 'indeedee-male',
                'morpeko-full-belly', 'cufant', 'copperajah', 'dracozolt', 'arctozolt', 'dracovish', 'arctovish',
                'duraludon', 'dreepy', 'drakloak', 'dragapult', 'zacian', 'zamazenta', 'eternatus', 'kubfu',
                'urshifu-single-strike', 'zarude', 'regieleki', 'regidrago', 'glastrier', 'spectrier', 'calyrex',
                'wyrdeer', 'kleavor', 'ursaluna', 'basculegion-male', 'sneasler', 'overqwil', 'enamorus-incarnate']
